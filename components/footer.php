<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         <h3>Contact Us.</h3>
         <a href="tel:9800000000"><i class="fas fa-phone"></i> +91 9342372731</a>
         <a href="tel:9900000000"><i class="fas fa-phone"></i> +91 9952633737</a>
         <a href="mailto:harshchy143@gmail.com"><i class="fas fa-envelope"></i> deneshraja235@gmail.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> Hasanamapettai, TamilNadu</a>
      </div>
   ...
   <div class="credit">&copy; Copyright @ <?= date('Y'); ?> by <span>DENESH</span> | all rights reserved!</div>
